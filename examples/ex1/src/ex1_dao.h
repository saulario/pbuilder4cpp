...
namespace ex1 {
    namespace dao {
        ...
        class CompoundDAO : public CommonDAO {
        private:
            static CompoundDAO * dao;
            static boost::mutex mtx;
            void loadColumns(tntdb::Row &, ex1::entity::Compound *);
            void setColumns(tntdb::Statement &, const ex1::entity::Compound *);
        public:
            ~CompoundDAO();
            static CompoundDAO * getInstance(void);
            ex1::entity::Compound * insert(tntdb::Connection &, ex1::entity::Compound *);
            std::list<ex1::entity::Compound *> query(tntdb::Connection &, tntdb::Statement &);
            ex1::entity::Compound * read(tntdb::Connection &, const ex1::entity::CompoundId &);
            tntdb::Statement::size_type remove(tntdb::Connection &, const ex1::entity::CompoundId &);
            ex1::entity::Compound * update(tntdb::Connection &, ex1::entity::Compound *);
        };
