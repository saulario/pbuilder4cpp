...
CREATE TABLE `test1` (
	...
	`tmediumint`		MEDIUMINT NOT NULL 			COMMENT 'Mediumint',
	`tmediumintUnsigned`	MEDIUMINT UNSIGNED NOT NULL 		COMMENT 'Mediumint unsigned',
	`tinteger`		INTEGER NOT NULL 			COMMENT 'Integer',
	`tintegerUnsigned`	INTEGER UNSIGNED NOT NULL 		COMMENT 'Integer unsigned',
	`tbigint`		BIGINT NOT NULL 			COMMENT 'Bigint',
	`tbigintUnsigned`	BIGINT UNSIGNED NOT NULL 		COMMENT 'Bigint unsigned',
