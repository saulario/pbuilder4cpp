...
${OBJECTDIR}/pbuilder_PersistenceBuilder.o: pbuilder_PersistenceBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pbuilder_PersistenceBuilder.o pbuilder_PersistenceBuilder.cpp

${OBJECTDIR}/pbuilder_analyzer_Analyzer.o: pbuilder_analyzer_Analyzer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pbuilder_analyzer_Analyzer.o pbuilder_analyzer_Analyzer.cpp

${OBJECTDIR}/pbuilder_analyzer_MysqlAnalyzer.o: pbuilder_analyzer_MysqlAnalyzer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pbuilder_analyzer_MysqlAnalyzer.o pbuilder_analyzer_MysqlAnalyzer.cpp

${OBJECTDIR}/pbuilder_analyzer_OracleAnalyzer.o: pbuilder_analyzer_OracleAnalyzer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pbuilder_analyzer_OracleAnalyzer.o pbuilder_analyzer_OracleAnalyzer.cpp

${OBJECTDIR}/pbuilder_analyzer_PostgresqlAnalyzer.o: pbuilder_analyzer_PostgresqlAnalyzer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pbuilder_analyzer_PostgresqlAnalyzer.o pbuilder_analyzer_PostgresqlAnalyzer.cpp
...
${OBJECTDIR}/pbuilder_render_TNTDBArtifactDeclarationRender.o: pbuilder_render_TNTDBArtifactDeclarationRender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pbuilder_render_TNTDBArtifactDeclarationRender.o pbuilder_render_TNTDBArtifactDeclarationRender.cpp

${OBJECTDIR}/pbuilder_render_TNTDBArtifactDefinitionRender.o: pbuilder_render_TNTDBArtifactDefinitionRender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pbuilder_render_TNTDBArtifactDefinitionRender.o pbuilder_render_TNTDBArtifactDefinitionRender.cpp

${OBJECTDIR}/pbuilder_render_TNTDBEntityDeclarationRender.o: pbuilder_render_TNTDBEntityDeclarationRender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pbuilder_render_TNTDBEntityDeclarationRender.o pbuilder_render_TNTDBEntityDeclarationRender.cpp

${OBJECTDIR}/pbuilder_render_TNTDBEntityDefinitionRender.o: pbuilder_render_TNTDBEntityDefinitionRender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pbuilder_render_TNTDBEntityDefinitionRender.o pbuilder_render_TNTDBEntityDefinitionRender.cpp
